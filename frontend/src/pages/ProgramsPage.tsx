...
import AddEditProgram from "../components/program/AddEditProgram";
...
const ProgramsPage: React.FC = () => {
  ...
  const [searchBy, setSearchBy] = useState<"all" | "code" | "name" | "college">("all");
  ...
  const handleSearchByChange = (value: string) => {
    setSearchBy(value as "all" | "code" | "name" | "college");
    setCurrentPage(1);
  };
    ...
    return (
      <div className="flex items-center justify-between w-full">
        <div className="text-sm text-gray-600">
          Showing <span className="font-medium">{startEntry}-{endEntry}</span> of <span className="font-medium">{displayTotal}</span> programs
        </div>
  ...
  return (
    <div className="w-full min-w-0 bg-white flex flex-col relative p-6" style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      <div className="space-y-6">
        {/* Page Header */}
        <div>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Programs Management</h1>
          <p className="text-gray-600">
            Manage all academic programs across colleges
          </p>
        </div>
            ...
            <CardContent className="p-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-600">Add new program to the system</p>
                  <p className="text-xs text-gray-500 mt-1">Create academic programs under each college</p>
                </div>
                <Button
